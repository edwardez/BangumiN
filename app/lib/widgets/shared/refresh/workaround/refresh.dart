...
/// the same values passed into the [MuninCupertinoSliverRefreshControl].
///
...
/// A callback function that's invoked when the [MuninCupertinoSliverRefreshControl] is
/// pulled a `refreshTriggerPullDistance`. Must return a [Future]. Upon
/// completion of the [Future], the [MuninCupertinoSliverRefreshControl] enters the
...
///    scrollable space.
class MuninCupertinoSliverRefreshControl extends StatefulWidget {
  ...
  /// a refresh.
  const MuninCupertinoSliverRefreshControl({
    Key key,
  ...
  static RefreshIndicatorMode state(BuildContext context) {
    final _MuninCupertinoSliverRefreshControlState state =
        context.ancestorStateOfType(
            const TypeMatcher<_MuninCupertinoSliverRefreshControlState>());
  ...
  @override
  _MuninCupertinoSliverRefreshControlState createState() =>
      _MuninCupertinoSliverRefreshControlState();
}

class _MuninCupertinoSliverRefreshControlState
    extends State<MuninCupertinoSliverRefreshControl> {
