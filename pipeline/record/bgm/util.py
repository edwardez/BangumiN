...
featurelist = [['キャラクターデザイン', '人物设定', '人设'],
               ...
               ['作曲', '作曲家', '作詞・作曲・編曲', '作編曲', 'composer', '作曲/编曲',
                'Composition', '作编曲', 'Composer', '作詞・作曲', 'Composers',
                'Compose'],
               ...
               ['发行商', '出版者', '唱片公司', '出版商'],
               ['厂牌'],
               ['Illustration & Design', 'Designer', 'Design & Artwork',
                'jacket', 'design',
                'Graphic Design', 'デザイン', 'Illustrations', 'Design Works',
                'イラスト',
                'Illustrator', 'Illustlation', 'Jacket Illust & Design',
                'Jacket Illust',
                'ILLUSTRATOR', 'Illust', 'Design', 'Jacket Illustration',
                'illust',
