package io.flutter.plugins.munin.permissionhandler;
 ...
 * https://github.com/BaseflowIT/flutter-permission-handler/blob/1a2365b/android/src/main/java/com/baseflow/permissionhandler/PermissionHandlerPlugin.java
...
public class PermissionHandlerPlugin implements MethodCallHandler {
    ...
    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "flutter.munin.com/permissions/methods");
